...
class orderbook_manager
{
    ...
    clear_orderbook()
    {
        ...
        const price_compare_desc = (a,b) => (a > b ? 1 : (a < b ? -1 : 0)); //(a,b) => (a  < b ? -1 : 1); //(a,b) => (a.price  > b.price ? -1 : (a.price < b.price ? 1 : 0));
        const price_equals = null;//(a,b) => (a.price  === b.price);
        this.orderbook = {asks: new SortedMap(null, price_equals, price_compare_desc), 
                          bids: new SortedMap(null, price_equals, price_compare_asc)};
    }
    ...
    get_orderbook(limit)
    {
        ...
        for (let order_type_index in order_types)
        {
